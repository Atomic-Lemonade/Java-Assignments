...
public class MagicSquare
{
	...
	/**
	 * Create a MagicSquare object with a specified number array.
	 * 
	 * @param numberArray an array of integers
	 */
	public MagicSquare(int[] numberArray) {
	...
	public boolean validateTotal()
	{
		...
		// For debugging: System.out.println("Total Checkpoint: " + validity);
	...
	public boolean validateNumbers()
	{
		...
		// For debugging: System.out.println("Number Checkpoint: " + validity);
	...
	public boolean validateSums()
	{
		...
		if (numberArray.length == 0) {
		    ...
		    // Use first row as target sum to compare with magic constant
		...
		// For debugging: System.out.println("Sums Checkpoint: " + validity);
